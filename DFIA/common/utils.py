...
def parse_args(arg_mode):
    ...
    ''' about dataset '''
    parser.add_argument('-dataset', type=str, default='cars',  choices=['tiered_meta_iNat','fc100','flowers','aircraft','cars','dogs','miniimagenet', 'cub', 'tieredimagenet', 'cifar_fs'])
    parser.add_argument('-data_dir', type=str, default='path', help='dir of datasets')
    ...
    parser.add_argument('-extra_dir', type=str, default='cars-ours', help='extra dir name added to checkpoint dir')
